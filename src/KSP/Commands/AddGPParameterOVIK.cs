namespace KSP
{
    ...
    class AddGPParameterOVIK : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_DuctCurves);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_FlexDuctCurves);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_PipeCurves);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_DuctTerminal);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_DuctAccessory);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_PipeAccessory);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_DuctLinings);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_DuctInsulations);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_PipeInsulations);
            catSet.Insert(catGP);
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_StructuralFraming);
            catSet.Insert(catGP);
            ...
            AddParams("GP_ИОС_Тепловая мощность", catSet, app, doc);
            AddParams("GP_ИОС_Холодильная_мощность", catSet, app, doc);
            ...
            catGP = doc.Settings.Categories.get_Item(BuiltInCategory.OST_PipeAccessory);
            catSet.Insert(catGP);
            AddParams("GP_Расход_Воздуха_Приток", catSet, app, doc);
            AddParams("GP_Расход_Воздуха_Вытяжка", catSet, app, doc);
            AddParams("GP_Расход_Тепло", catSet, app, doc);
            AddParams("GP_Расход_Холод", catSet, app, doc);
