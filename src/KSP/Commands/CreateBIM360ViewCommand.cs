namespace KSP
{
    ...
    public class CreateBIM360ViewCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            {
                TaskDialog.Show("KSP", "Уйди с 3d вида");
                return Result.Succeeded;
            }

            var infoText = "";
            string fileName = doc.Title;
            string cropFileName = CommonMethods.CropFileName(fileName);
            ...
            using (Transaction setView = new Transaction(doc, "Some"))
            {
                ...
                IList<Parameter> p1List = activeView3D.GetParameters(name: "Уровень группировки 1");
                IList<Parameter> p2List = activeView3D.GetParameters(name: "Уровень группировки 2");
        ...
        private View3D CreateView(Document doc)
        {
            ...
            var eyePos = new XYZ(-1, -1, 0);
            var upDir = new XYZ(0, 0, 1);
            var forwardDir = new XYZ(1, 1, 0);
            ...
            using (Transaction ttNew = new Transaction(doc, "new 3D View"))
            {
                ...
                view.Name = "Экспорт в Navisworks";
                ttNew.Commit();
            }
            return view;
        }
